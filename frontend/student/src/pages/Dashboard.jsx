...
export default function Dashboard() {
  ...
  const stats = [
    ...
    { title: 'Attendance Avg', value: '88%', meta: 'This week', spark: [80,85,90,88,87,89,88] },
    { title: 'Assignments Due', value: '12', meta: 'Due this week', spark: [2,3,1,4,3,2,2] },
    { title: 'Avg Marks', value: '76%', meta: 'Last exam', spark: [70,72,75,78,76,77,76] }
  ]
    ...
    <Layout>
      <div style={{ padding: 24 }}>
        ...
        <div className="stats-grid">
          {stats.map((s) => <StatsCard key={s.title} title={s.title} value={s.value} meta={s.meta} spark={s.spark} />)}
        </div>
